...
export interface LayoutMessengerGridProps extends ColumnProps
{
    itemImage?: string;
    itemColor?: string;
    itemActive?: boolean;
...
export const LayoutMessengerGrid: FC<LayoutMessengerGridProps> = props =>
{
    ...
    {
        const newClassNames: string[] = [ 'layout-grid-item-messenger' ];
