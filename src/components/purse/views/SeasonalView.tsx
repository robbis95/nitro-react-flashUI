...
export const SeasonalView: FC<SeasonalViewProps> = props =>
{
    ...
    return (
        <Flex fullWidth justifyContent="between" className={ 'nitro-purse-seasonal-currency nitro-notification position-relative ' + GetConfiguration<boolean>('currency.seasonal.color') }>
            <Flex fullWidth>
