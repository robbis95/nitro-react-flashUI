...
export const InventoryView: FC<{}> = props =>
{
    ...
    return (
        <NitroCardView uniqueKey={ 'inventory' } className={ `${ isTrading ? 'nitro-inventory trading no-resize' : 'nitro-inventory' }` } theme={ isTrading ? 'primary' : '' } style={ { width: isTrading ? '490px' : '4px' } }>
